...
const weddingConfig = {
  groom: '贺鹏辉',
  bride: '黄一清',
  groomLatin: 'HE PENGHUI',
  brideLatin: 'HUANG YIQING',
  weddingDate: '2026-10-06T12:00:00+08:00',
  dateDot: '2026 · 10 · 06',
  dateCn: '2026年10月6日 · 星期二',
  calendarMonth: 'OCT',
  calendarDay: '06',
  calendarYear: '2026',
  venue: '简阳市城市名人酒店二楼天府雄州厅',
  venueShort: '城市名人酒店',
  navigationUrl: 'https://surl.amap.com/1RZecRI1r9CD',
  schedule: [
    { label: '签到', time: '10:00', description: '领取今日任务，与老朋友相见' },
    { label: '合影', time: '10:00', description: '保存这一份快乐存档' },
    { label: '仪式', time: '12:08', description: '见证拥抱、誓言与交换戒指' },
    { label: '喜宴', time: '12:30', description: '共享一场丰盛的秋日宴席' },
  ],
}
